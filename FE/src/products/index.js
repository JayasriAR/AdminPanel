...
function ProductTable() {
  ...
  const handleSave = async (productId) => {
    try {
      ...
      await axios.put(`https://adminpanel-m7rn.onrender.com/products/edit_product/${productId}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });

      const response = await axios.get('https://adminpanel-m7rn.onrender.com/products/get_all_products', {
  ...
  useEffect(() => {
    axios
      .get('https://adminpanel-m7rn.onrender.com/products/get_all_products', {
        headers: customHeaders
})
  ...
  const handleDelete = async (productId) => {
    try {
      await axios.delete(`https://adminpanel-m7rn.onrender.com/products/delete_product/${productId}`, {
        headers: {
          'authorization': localStorage.getItem('token'),
        },
      });

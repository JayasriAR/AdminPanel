...
function UserTable() {
  ...
  useEffect(() => {
        axios.get('https://adminpanel-m7rn.onrender.com/users/get_all_users', {
  ...
  const handleSave = async (userId) => {
    try {
      ...
      await axios.put(`https://adminpanel-m7rn.onrender.com/users/edit_user/${userId}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });

      const response = await axios.get('https://adminpanel-m7rn.onrender.com/users/get_all_users', {
        headers: customHeaders,
      });
  ...
  const handleDelete = async (userId) => {
    try {
      await axios.delete(`https://adminpanel-m7rn.onrender.com/users/delete_user/${userId}`, {
        headers: {
          'authorization': localStorage.getItem('token'),
        },
      });

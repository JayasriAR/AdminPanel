...
function VendorTable() {
  ...
  useEffect(() => {
    axios
      .get('https://adminpanel-m7rn.onrender.com/vendors/get_all_vendors', {
  ...
  const handleDelete = async (vendorId) => {
    try {
      await axios.delete(`https://adminpanel-m7rn.onrender.com/vendors/delete_vendor/${vendorId}`, {
        headers: {
          'authorization': localStorage.getItem('token'),
        },
      });

      const response = await axios.get('https://adminpanel-m7rn.onrender.com/vendors/get_all_vendors', {
        headers: customHeaders,
      });
  ...
  try {
    ...
    await axios.put(`https://adminpanel-m7rn.onrender.com/vendors/edit_vendor/${vendorId}`, updatedData);
